  ...
  return (
    <section id="home" className="hero w-screen h-screen bg-gradient-to-r from-gray-900 to-gray-800 flex items-center justify-center p-4">
      <div className="text-center">
        ...
        <button className="mt-6 px-6 py-3 sm:px-8 sm:py-3 bg-gradient-to-r from-teal-400 to-blue-500 text-white rounded-full shadow-lg hover:bg-opacity-80 hover:shadow-xl transform hover:scale-125 transition-transform duration-500 ease-in-out">
          View My Work
        </button>
      </div>
    </section>
