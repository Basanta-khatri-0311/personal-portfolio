...
const Hero = () => {
  return (
    ...
    //     </p>
    //     <button className="mt-6 px-6 py-3 sm:px-8 sm:py-3 bg-gradient-to-r from-teal-400 to-blue-500 text-white rounded-full shadow-lg hover:opacity-80 transform hover:scale-105 transition-transform duration-500 ease-in-out">
    //       View My Work
    //     </button>
    //   </div>
    // </section>
