  ...
  return (
    <section className="hidden fixed top-1/2 right-4 transform -translate-y-1/2 lg:flex flex-col space-y-4 ">
      <a
        ...
        className="text-3xl text-white bg-gray-800 hover:bg-blue-600 hover:scale-150  transition duration-300 p-2 rounded-full shadow-lg"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="text-3xl text-white bg-gray-800 hover:bg-gray-900 hover:scale-150 transition duration-300 p-2 rounded-full shadow-lg"
      >
